...
import "@matterlabs/zksync-contracts/l2/system-contracts/openzeppelin/token/ERC20/utils/SafeERC20.sol";
...
import "@matterlabs/zksync-contracts/l2/system-contracts/libraries/RLPEncoder.sol";
...
struct Transaction {
    ...
    // Root set by account owner for recovery verification
    bytes32 merkleRoot;
    // Used for recovery
    string password;
    // Used for recovery
 ...
 */
library MerkleTransactionHelper {
